...
import { getNext7Days, getDayName, getDayOfMonth, isToday, calculateDayTotals } from '@/lib/dateUtils';
          ...
          {next7Days.map((day, index) => {
            ...
            return (
              <div
                key={index}
                className={cn(
                  'p-2 rounded-lg border flex flex-col items-center justify-between min-h-[100px]',
