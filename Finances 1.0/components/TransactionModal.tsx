...
export function TransactionModal({ 
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const transaction: Omit<Transaction, 'id'> = {
      ...
      monthlyInterest: formData.type === 'debt' ? calculateMonthlyInterest(formData) : undefined,
  ...
  const calculatedMonthlyInterest = isDebt ? calculateMonthlyInterest(formData) : 0;
